...
export namespace std {
  ...
  //  using std::const_iterator; NOT IMPLEMENTED
  //  using std::const_sentinel; NOT IMPLEMENTED
  //  using std::iter_const_reference_t; NOT IMPLEMENTED?

  // [const.iterators.iterator], class template basic_const_iterator
  //  using std::basic_const_iterator; NOT IMPLEMENTED

  using std::common_type;

  //  using std::make_const_iterator; NOT IMPLEMENTED

  // [move.iterators], move iterators and sentinels
  using std::move_iterator; // freestanding
