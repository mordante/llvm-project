...
export namespace std {
  ...
  //  using std::start_lifetime_as; NOT IMPLEMENTED
  //  using std::start_lifetime_as_array NOT IMPLEMENTED;
  ...
  using std::allocator_traits; // freestanding
  ...
  //  using std::out_ptr_t NOT IMPLEMENTED;

  // [out.ptr], function template out_ptr
  //  using std::out_ptr NOT IMPLEMENTED;

  // [inout.ptr.t], class template inout_ptr_t
  //  using std::inout_ptr_t NOT IMPLEMENTED;

  // [inout.ptr], function template inout_ptr
  //  using std::inout_ptr NOT IMPLEMENTED;
