...
export namespace std {
  ...
  namespace ranges {
    ...
    // using std::ranges::const_iterator_t; NOT IMPLEMENTED YET
    // using std::ranges::const_sentinel_t; NOT IMPLEMENTED YET
    using std::ranges::iterator_t;
    // using std::ranges::range_const_reference_t; NOT IMPLEMENTED YET
    ...
    // using std::ranges::constant_range; NOT IMPLEMENTED YET
  ...
  namespace ranges {
    ...
    // using std::ranges::elements_of; NOT IMPLEMENTED YET
    ...
    // using std::ranges::to; NOT YET IMPLEMENTED
    ...
    using std::ranges::single_view; // freestanding
...
#  endif
    ...
    // using std::ranges::range_adaptor_closure; NOT IMPLEMENTED YET
  ...
  // using std::from_range_t; NOT IMPLEMENTED YET
