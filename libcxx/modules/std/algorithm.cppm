...
export namespace std {
  namespace ranges {
    ...
    // using std::ranges::in_value_result; NOT IMPLEMENTED YET
    using std::ranges::min_max_result;
    // using std::ranges::out_value_result; NOT IMPLEMENTED YET
  } // namespace ranges
  ...
  namespace ranges {
    // using std::ranges::shift_left; NOT IMPLEMENTED YET
  }

  using std::shift_right;

  namespace ranges {
    // using std::ranges::shift_right; NOT IMPLEMENTED YET
  }
