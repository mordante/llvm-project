...
export namespace std {
  ...
  namespace chrono {
    ...
    // using std::chrono::is_clock; NOT IMPLEMENTEDYET
    ...
    using std::chrono::operator<<;
#endif
    // using std::chrono::from_stream; NOT IMPLEMENTEDYET
    ...
    // using std::chrono::clock_time_conversion; NOT IMPLEMENTED YET

    // using std::chrono::clock_cast; NOT IMPLEMENTED YET
  ...
  namespace chrono {
    // using std::chrono::parse;NOT IMPLEMENTED YET
