...
public:
  ...
  //
  //
  // The constructor is unspecified, since members are constexpr it
  // is implied these constructors can be constexpr
  _LIBCPP_HIDE_FROM_ABI explicit constexpr leap_second(sys_seconds __date, seconds __value)
