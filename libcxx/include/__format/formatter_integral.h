 ...
 */
_LIBCPP_HIDE_FROM_ABI inline string __determine_grouping(ptrdiff_t __size,
                                                         const string& __grouping) { /// XXX integral or arithmetic
...
_LIBCPP_HIDE_FROM_ABI auto __format_char(integral auto __value, output_iterator<const _CharT&> auto __out_it,
                                         __format_spec::__parser<_CharT> __parser) -> decltype(__out_it) {
  ...
  return __formatter::__write(_VSTD::addressof(__c), _VSTD::addressof(__c) + 1, _VSTD::move(__out_it), __parser);
}
...
_LIBCPP_HIDE_FROM_ABI auto __format_integer(_Tp __value, auto& __ctx, __format_spec::__parser<_CharT> __parser,
                                            bool __negative, char* __begin, char* __end, const char* __prefix,
                                            int __base) -> decltype(__ctx.out()) {
  char* __first = __formatter::__insert_sign(__begin, __negative, __parser.__sign_);
  if (__parser.__alternate_form_ && __prefix)
    while (*__prefix)
      *__first++ = *__prefix++;
...
#    ifndef _LIBCPP_HAS_NO_LOCALIZATION
  if (__parser.__locale_specific_form_) {
    ...
    if (!__grouping.empty() && __size > __grouping[0])
      return __formatter::__format_grouping(__ctx.out(), __begin, __first, __last,
                                            __formatter::__determine_grouping(__size, __grouping), __np.thousands_sep(),
                                            __parser);
  }
#    endif
  ...
  if (__parser.__alignment_ != __format_spec::__alignment::__default)
    ...
    __parser.__width_ -= _VSTD::min(__size, __parser.__width_);
  }

  if (__parser.__type_ != __format_spec::__type::__hexadecimal_upper_case) [[likely]]
    return __formatter::__write(__first, __last, __ctx.out(), __parser);

  return __formatter::__write_transformed(__first, __last, __ctx.out(), __parser, __formatter::__hex_to_upper);
}
...
_LIBCPP_HIDE_FROM_ABI auto __format_integer(_Tp __value, auto& __ctx, __format_spec::__parser<_CharT> __parser,
  ...
  case __format_spec::__type::__binary_lower_case: {
    ...
    return __formatter::__format_integer(__value, __ctx, __parser, __negative, __array.begin(), __array.end(), "0b", 2);
  }
  ...
  case __format_spec::__type::__octal: {
    ...
    return __formatter::__format_integer(__value, __ctx, __parser, __negative, __array.begin(), __array.end(),
                                         __value != 0 ? "0" : nullptr, 8);
  }
  case __format_spec::__type::__decimal: {
    array<char, __formatter::__buffer_size<decltype(__value), 10>()> __array;
    return __formatter::__format_integer(__value, __ctx, __parser, __negative, __array.begin(), __array.end(), nullptr,
                                         10);
  }
  case __format_spec::__type::__hexadecimal_lower_case: {
    array<char, __formatter::__buffer_size<decltype(__value), 16>()> __array;
    return __formatter::__format_integer(__value, __ctx, __parser, __negative, __array.begin(), __array.end(), "0x",
                                         16);
  }
...
_LIBCPP_HIDE_FROM_ABI auto __format_integer(_Tp __value, auto& __ctx, __format_spec::__parser<_CharT> __parser)
  ...
  return __formatter::__format_integer(__r, __ctx, __parser, __negative);
}
...
template <class _CharT>
_LIBCPP_HIDE_FROM_ABI auto __format_bool(bool __value, auto& __ctx, __format_spec::__parser<_CharT> __parser) {

#    ifndef _LIBCPP_HAS_NO_LOCALIZATION
  if (__parser.__locale_specific_form_) {
    const auto& __np = use_facet<numpunct<_CharT>>(__ctx.locale());
    basic_string<_CharT> __str = __value ? __np.truename() : __np.falsename();
    return __formatter::__write_unicode_no_precision(basic_string_view<_CharT>{__str}, __ctx.out(), __parser);
  }
#    endif
  basic_string_view<_CharT> __str =
      __value ? __formatter::__bool_strings<_CharT>::__true : __formatter::__bool_strings<_CharT>::__false;
  return __formatter::__write(__str.begin(), __str.end(), __ctx.out(), __parser);
}
