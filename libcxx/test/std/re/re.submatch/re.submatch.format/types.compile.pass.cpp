...
static_assert(std::semiregular<std::formatter<std::sub_match<const char*>, char>>);

#ifndef TEST_HAS_NO_WIDE_CHARACTERS
static_assert(std::semiregular<std::formatter<std::sub_match<const wchar_t*>, wchar_t>>);
#endif
