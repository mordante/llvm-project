...
#include <__format/formatter_v2.h> // expected-error@*:* {{use of private header from outside its module: '__format/formatter_v2.h'}}
...
#include <__format/parser_std_format_spec_v2.h> // expected-error@*:* {{use of private header from outside its module: '__format/parser_std_format_spec_v2.h'}}
