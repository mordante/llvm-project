...
constexpr void test_as_string() {
  ...
  // *** Sign ***
  test_exception("A sign field isn't allowed in this format-spec", CSTR("-}"));
  test_exception("A sign field isn't allowed in this format-spec", CSTR("-s}"));

  // *** Alternate form ***
  test_exception("An alternate form field isn't allowed in this format-spec",
                 CSTR("#}"));
  test_exception("An alternate form field isn't allowed in this format-spec",
                 CSTR("#s}"));

  // *** Zero padding ***
  test_exception("A zero-padding field isn't allowed in this format-spec",
                 CSTR("0}"));
  test_exception("A zero-padding field isn't allowed in this format-spec",
                 CSTR("0s}"));
  ...
  test_exception("A format-spec width field shouldn't have a leading zero",
                 CSTR("00"));
  ...
  test({.width = 2'147'483'647, .width_as_arg = false}, 10,
       CSTR("2147483647}"));
  test_exception("The numeric value of the format-spec is too large",
                 CSTR("2147483648"));
  test_exception("The numeric value of the format-spec is too large",
                 CSTR("5000000000"));
  test_exception("The numeric value of the format-spec is too large",
  ...
  test_exception("A format-spec arg-id should terminate at a '}'", CSTR("{0"));
  test_exception(
      "The arg-id of the format-spec starts with an invalid character",
      CSTR("{a"));
  test_exception("A format-spec arg-id should terminate at a '}'", CSTR("{1"));
  test_exception("A format-spec arg-id should terminate at a '}'", CSTR("{9"));
  test_exception("A format-spec arg-id should terminate at a '}'", CSTR("{9:"));
  test_exception("A format-spec arg-id should terminate at a '}'", CSTR("{9a"));
  ...
  // *** Precision ***
  test_exception("The format-spec should consume the input or end with a '}'",
                 CSTR("."));
  test_exception("The format-spec should consume the input or end with a '}'",
                 CSTR(".1"));
...
constexpr void test_as_char() {
  ...
  // *** Sign ***
  test_exception("A sign field isn't allowed in this format-spec", CSTR("-c}"));
...
constexpr void test() {
  ...
  // *** Type ***
  {
    ...
    test_exception(expected, CSTR("A}"));
    test_exception(expected, CSTR("E}"));
    test_exception(expected, CSTR("F}"));
    test_exception(expected, CSTR("G}"));
    test_exception(expected, CSTR("a}"));
    test_exception(expected, CSTR("e}"));
    test_exception(expected, CSTR("f}"));
    test_exception(expected, CSTR("g}"));
    test_exception(expected, CSTR("p}"));
  }
